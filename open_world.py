...
def main():
    ...
    train_data = np.load('.../open_world_train.npz')     # Input training dataset
    temp_data = np.load('.../open_world_temp.npz')     # Input temporary dataset, which will be split into validating dataset and testing dataset
